...
class VilleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AppBundle:ville:index.html.twig', array(
            'villes' => $villes,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('AppBundle:ville:new.html.twig', array(
            'ville' => $ville,
    ...
    public function showAction(Ville $ville)
    {
        ...
        return $this->render('AppBundle:ville:show.html.twig', array(
            'ville' => $ville,
    ...
    public function editAction(Request $request, Ville $ville)
    {
        ...
        return $this->render('AppBundle:ville:edit.html.twig', array(
            'ville' => $ville,
